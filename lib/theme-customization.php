 ...
 */
function businessportfolio_custom_header_and_background() {
	 ...
	 * }
	 */
	add_theme_support( 'custom-background', apply_filters( 'businessportfolio_custom_background_args', array(
	 ...
	 * }
	 */
	add_theme_support( 'custom-header', apply_filters( 'businessportfolio_custom_header_args', array(
		'default-text-color'     => $default_text_color,
		'width'                  => 1200,
		'height'                 => 280,
		'flex-height'            => true,
		'wp-head-callback'       => 'businessportfolio_header_style',
	) ) );
}
//add_action( 'after_setup_theme', 'businessportfolio_custom_header_and_background' );

if ( ! function_exists( 'businessportfolio_header_style' ) ) :
/**
 ...
 */
function businessportfolio_header_style() {
	...
	?>
	<style type="text/css" id="businessportfolio-header-css">
		.site-branding {
			margin: 0 auto 0 0;
		}
...
endif; // businessportfolio_header_style
 ...
 */
function businessportfolio_customize_register( $wp_customize ) {
	$color_scheme = businessportfolio_get_color_scheme();
	...
	$wp_customize->add_setting( 'color_scheme', array(
		'default'           => 'default',
		'sanitize_callback' => 'businessportfolio_sanitize_color_scheme',
		'transport'         => 'postMessage',
	) );

	$wp_customize->add_control( 'color_scheme', array(
		'label'    => __( 'Base Color Scheme', 'businessportfolio' ),
		'section'  => 'colors',
		'type'     => 'select',
		'choices'  => businessportfolio_get_color_scheme_choices(),
		'priority' => 1,
	) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'page_background_color', array(
		'label'       => __( 'Page Background Color', 'businessportfolio' ),
		'section'     => 'colors',
	) ) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'link_color', array(
		'label'       => __( 'Link Color', 'businessportfolio' ),
		'section'     => 'colors',
	) ) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'main_text_color', array(
		'label'       => __( 'Main Text Color', 'businessportfolio' ),
		'section'     => 'colors',
	) ) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'secondary_text_color', array(
		'label'       => __( 'Secondary Text Color', 'businessportfolio' ),
		'section'     => 'colors',
	) ) );
}
 ...
 */
function businessportfolio_get_color_schemes() {
	/**
	 ...
	 * }
	 */
	return apply_filters( 'businessportfolio_color_schemes', array(
		'default' => array(
			'label'  => __( 'Default', 'businessportfolio' ),
			'colors' => array(
				'#1a1a1a',
				'#ffffff',
				'#007acc',
		...
		'dark' => array(
			'label'  => __( 'Dark', 'businessportfolio' ),
			'colors' => array(
				'#262626',
				'#1a1a1a',
				'#9adffd',
		...
		'gray' => array(
			'label'  => __( 'Gray', 'businessportfolio' ),
			'colors' => array(
				'#616a73',
				'#4d545c',
				'#c7c7c7',
		...
		'red' => array(
			'label'  => __( 'Red', 'businessportfolio' ),
			'colors' => array(
				'#ffffff',
				'#ff675f',
				'#640c1f',
		...
		'yellow' => array(
			'label'  => __( 'Yellow', 'businessportfolio' ),
			'colors' => array(
				'#3b3721',
				'#ffef8e',
				'#774e24',
...
if ( ! function_exists( 'businessportfolio_get_color_scheme' ) ) :
/**
 ...
 */
function businessportfolio_get_color_scheme() {
	$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
	$color_schemes       = businessportfolio_get_color_schemes();
...
endif; // businessportfolio_get_color_scheme

if ( ! function_exists( 'businessportfolio_get_color_scheme_choices' ) ) :
/**
 ...
 */
function businessportfolio_get_color_scheme_choices() {
	$color_schemes                = businessportfolio_get_color_schemes();
...
endif; // businessportfolio_get_color_scheme_choices


if ( ! function_exists( 'businessportfolio_sanitize_color_scheme' ) ) :
/**
 ...
 */
function businessportfolio_sanitize_color_scheme( $value ) {
	$color_schemes = businessportfolio_get_color_scheme_choices();
...
endif; // businessportfolio_sanitize_color_scheme
 ...
 */
function businessportfolio_color_scheme_css() {
	$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
...
//	$color_textcolor_rgb = businessportfolio_hex2rgb( $color_scheme[3] );
	...
	$color_scheme_css = businessportfolio_get_color_scheme_css( $colors );

	wp_add_inline_style( 'businessportfolio-style', $color_scheme_css );
}
add_action( 'wp_enqueue_scripts', 'businessportfolio_color_scheme_css' );
...
function businessportfolio_customize_control_js() {
	...
	wp_localize_script( 'color-scheme-control', 'colorScheme', businessportfolio_get_color_schemes() );
}
add_action( 'customize_controls_enqueue_scripts', 'businessportfolio_customize_control_js' );
...
add_action( 'customize_preview_init', 'businessportfolio_customize_preview_js' );
 ...
 */
function businessportfolio_get_color_scheme_css( $colors ) {
...
function businessportfolio_color_scheme_css_template() {
	...
	?>
	<script type="text/html" id="tmpl-businessportfolio-color-scheme">
		<?php echo businessportfolio_get_color_scheme_css( $colors ); ?>
	</script>
	<?php
}
add_action( 'customize_controls_print_footer_scripts', 'businessportfolio_color_scheme_css_template' );
 ...
 * @see wp_add_inline_style()
 */
function businessportfolio_page_background_color_css() {
	$color_scheme          = businessportfolio_get_color_scheme();
	...
	wp_add_inline_style( 'businessportfolio-style', sprintf( $css, $page_background_color ) );
}
add_action( 'wp_enqueue_scripts', 'businessportfolio_page_background_color_css', 11 );
 ...
 * @see wp_add_inline_style()
 */
function businessportfolio_link_color_css() {
	$color_scheme    = businessportfolio_get_color_scheme();
	...
	wp_add_inline_style( 'businessportfolio-style', sprintf( $css, $link_color ) );
}
add_action( 'wp_enqueue_scripts', 'businessportfolio_link_color_css', 11 );
 ...
 * @see wp_add_inline_style()
 */
function businessportfolio_main_text_color_css() {
	$color_scheme    = businessportfolio_get_color_scheme();
	...
	wp_add_inline_style( 'businessportfolio-style', sprintf( $css, $main_text_color, $border_color ) );
}
add_action( 'wp_enqueue_scripts', 'businessportfolio_main_text_color_css', 11 );
 ...
 * @see wp_add_inline_style()
 */
function businessportfolio_secondary_text_color_css() {
	$color_scheme    = businessportfolio_get_color_scheme();
	...
	wp_add_inline_style( 'businessportfolio-style', sprintf( $css, $secondary_text_color ) );
}
